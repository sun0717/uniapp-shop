...
const onScrolltolower = async () => {
    ...
    // 数组追加
    curresubTypes.goodsItems.items.push(...newsubTypes.goodsItems.items)
}
</script>
...
<template>
    <view class="viewport">
        ...
        <!-- 推荐选项 -->
        <view class="tabs">
            <text class="text" v-for="(item, index) in subTypes" :class="{ active: index === activeIndex }"
                @tap="activeIndex = index" :key="item.id">{{ item.title }}</text>
        </view>
        <!-- 推荐列表 -->
